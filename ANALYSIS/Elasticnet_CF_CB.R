...
# point the directory (choose method among = RMA, GCRMA, MAS5, dCHIP, metaGEO, fRMA, barcode or comBat)
method= "comBat"
...
load("MATRIX_TS_CB.Rdata")
load("MATRIX_VS_CB.Rdata")
load("MATRIX_VS2_CB.Rdata")
load("MATRIX_VS3_CB.Rdata")
load("y_TS.Rdata")
load("y_VS.Rdata")
load("y_VS2.Rdata")
load("y_OS_TS.Rdata")
...
MATRIX_TS <- MATRIX_TS_CB
MATRIX_VS <- MATRIX_VS_CB
MATRIX_VS2 <- MATRIX_VS2_CB
MATRIX_VS3 <- MATRIX_VS3_CB
##############################################################################################
