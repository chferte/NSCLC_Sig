...
PATH <- "/home/cferte/FELLOW/cferte/NSCLC_MA/"
...
DirExp <- exprs(Dir_metaGEO$hgu133a)
ZhuExp <- exprs(Zhu_metaGEO$hgu133a)
HouExp <- exprs(Hou_metaGEO$hgu133plus2)
GirExp <- exprs(Gir_metaGEO$hgu133plus2)
...
y_TS <- MATRIX_TS[12162,]
y_OS_TS <- t(MATRIX_TS[c(12163,12164),])
colnames(y_OS_TS) <-c("time","status")
MATRIX_TS  <- MATRIX_TS[-12164,]
MATRIX_TS  <- MATRIX_TS[-12163,]
MATRIX_TS  <- MATRIX_TS[-12162,]
dim(MATRIX_TS)
length(y_TS)
dim(y_OS_TS)
...
y_VS <- MATRIX_VS[12162,]
y_OS_VS <- t(MATRIX_VS[c(12163,12164),])
colnames(y_OS_VS) <-c("time","status")
MATRIX_VS  <- MATRIX_VS[-12164,]
MATRIX_VS  <- MATRIX_VS[-12163,]
MATRIX_VS  <- MATRIX_VS[-12162,]
dim(MATRIX_VS)
length(y_VS)
dim(y_OS_VS)
...
y_VS2 <- MATRIX_VS2[12162,]
y_OS_VS2 <- t(MATRIX_VS2[c(12163,12164),])
colnames(y_OS_VS2) <-c("time","status")
MATRIX_VS2  <- MATRIX_VS2[-12164,]
MATRIX_VS2  <- MATRIX_VS2[-12163,]
MATRIX_VS2  <- MATRIX_VS2[-12162,]
dim(MATRIX_VS2)
length(y_VS2)
dim(y_OS_VS2)
...
y_VS3 <- MATRIX_VS3[12162,]
y_OS_VS3 <- t(MATRIX_VS3[c(12163,12164),])
colnames(y_OS_VS3) <-c("time","status")
MATRIX_VS3  <- MATRIX_VS3[-12164,]
MATRIX_VS3  <- MATRIX_VS3[-12163,]
MATRIX_VS3  <- MATRIX_VS3[-12162,]
dim(MATRIX_VS3)
length(y_VS3)
dim(y_OS_VS3)
...
############################################################################################################################
setwd(paste("/home/cferte/FELLOW/cferte/NSCLC_MA/MATRIX_RESP_OBJECTS/",NORM,sep=""))
getwd()
