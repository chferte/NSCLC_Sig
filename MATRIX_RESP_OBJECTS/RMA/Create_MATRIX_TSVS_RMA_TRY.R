...
for(NORM in c("RMA","GCRMA","fRMA", "MAS5", "barcode", "dCHIP", "metaGEO") 
    {
PATH <- "/home"
...
rownames(DirClin1) <- sub("__","_",rownames(DirClin1)) 
...
table(rownames(ZhuClin2)==colnames(ZhuExp1))
...
MATRIX_VS3 <- GirExp1
y_VS3 <- GirClin1[,c("THREE_YEAR_OS","MONTHS_TO_LAST_CONTACT_OR_DEATH","VITAL_STATUS")]
y_OS_VS3 <- GirClin1[,c("THREE_YEAR_OS","MONTHS_TO_LAST_CONTACT_OR_DEATH","VITAL_STATUS")]
